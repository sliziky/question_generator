...
public:
    ...
    void setupUi(QDialog *QuestionGenerator)
    {
        ...
        QuestionGenerator->resize(766, 903);
        ...
        groupBox_3->setGeometry(QRect(20, -20, 711, 1051));
        layoutWidget = new QWidget(groupBox_3);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(0, 200, 688, 661));
        ...
        sizePolicy.setHeightForWidth(answerButton_1->sizePolicy().hasHeightForWidth());
        answerButton_1->setSizePolicy(sizePolicy);
...
""));
        ...
        sizePolicy.setHeightForWidth(answerButton_2->sizePolicy().hasHeightForWidth());
        answerButton_2->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(answerButton_3->sizePolicy().hasHeightForWidth());
        answerButton_3->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(answerButton_4->sizePolicy().hasHeightForWidth());
        answerButton_4->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(answerButton_5->sizePolicy().hasHeightForWidth());
        answerButton_5->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(answerButton_6->sizePolicy().hasHeightForWidth());
        answerButton_6->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(answerButton_7->sizePolicy().hasHeightForWidth());
        answerButton_7->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(answerButton_8->sizePolicy().hasHeightForWidth());
        answerButton_8->setSizePolicy(sizePolicy);
        ...
        layoutWidget1->setGeometry(QRect(0, 30, 681, 121));
        ...
        horizontalLayout_11->addWidget(showAnswersButton);
        ...
        horizontalLayout_11->addWidget(generate);
        ...
        sizePolicy3.setHeightForWidth(maxSpinBox->sizePolicy().hasHeightForWidth());
        maxSpinBox->setSizePolicy(sizePolicy3);
        ...
        sequential = new QCheckBox(layoutWidget2);
        ...
        layoutWidget3->setGeometry(QRect(10, 20, 541, 701));
    ...
    void retranslateUi(QDialog *QuestionGenerator)
    {
        ...
        generate->setText(QApplication::translate("QuestionGenerator", "Skip", nullptr));
        ...
        label_12->setText(QApplication::translate("QuestionGenerator", "SCORE", nullptr));
